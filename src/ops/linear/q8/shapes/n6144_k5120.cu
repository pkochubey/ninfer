...
using C4       = Q8A16SlicedKMmaSchedule<8, 16, 1, 2, Access::Direct, Cache::ca, Cache::cg,
                                         Stage::RuntimeActive>;
using C8 =
...
using C16 =
    Q8A16SlicedKMmaSchedule<16, 8, 1, 3, Access::Shared, Cache::ca, Cache::cg, Stage::ActiveOnly>;
using C24 = Q8A16SlicedKMmaSchedule<24, 4, 1, 2, Access::Shared, Cache::ca, Cache::cg,
                                    Stage::RuntimeActive>;
using C32 =
...
Q8Launch select_q8_n6144_k5120(std::int32_t tokens) {
    ...
    if (tokens <= 192) return launch_q8_a16_mma_r32_t64;
